...
namespace WeaponAndWizardry.App_Code
{
    ...
    public partial class ScriptEngine
    {
        ...
        private void LoadScripts()
        {
            ...
            _scriptLines.Add(Line5);
            _scriptLines.Add(Line6);
            _scriptLines.Add(Line7);
            _scriptLines.Add(Line8);
            _scriptLines.Add(Line9);
            _scriptLines.Add(Line10);
            _scriptLines.Add(Line11);
            _scriptLines.Add(Line12);
            _scriptLines.Add(Line13);
            _scriptLines.Add(Line14);
            _scriptLines.Add(Line15);
            _scriptLines.Add(Line16);
            _scriptLines.Add(Line17);
            _scriptLines.Add(Line18);
            _scriptLines.Add(Line19);
            _scriptLines.Add(Line20);
            _scriptLines.Add(Line21);
            _scriptLines.Add(Line22);
            _scriptLines.Add(Line23);
            _scriptLines.Add(Line24);
            _scriptLines.Add(Line25);
            _scriptLines.Add(Line26);
            _scriptLines.Add(Line27);
            _scriptLines.Add(Line28);
            _scriptLines.Add(Line28);
            _scriptLines.Add(Line30);
        }
        ...
        {
            SetChoiceButtons(nextChoice);
            AddForegroundImage("Illia.png", 150, 100, 12, 550, 500);
