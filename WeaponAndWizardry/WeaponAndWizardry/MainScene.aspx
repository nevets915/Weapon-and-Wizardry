        ...
        <div class="wrapper">
            <div class="row">
                ...
                <div class="col-md-4" style="height:500px; min-height:500px; background-color:rgba(255, 255, 255, 0.9)">
                    ...
                    <asp:Label ID="Label_HP" runat="server" Text="HP: " Font-Size="Large"></asp:Label> <br />
                    <asp:Label ID="Label_Str" runat="server" Text="Str: " Font-Size="Large"></asp:Label> <br />
                    <asp:Label ID="Label_Dex" runat="server" Text="Dex: " Font-Size="Large"></asp:Label>  <br />
                    <asp:Label ID="Label_Int" runat="server" Text="Int: " Font-Size="Large"></asp:Label>  <br />
                    <asp:Label ID="Label_Luck" runat="server" Text="Luk: " Font-Size="Large"></asp:Label>  <br />
                    <asp:Label ID="Label_Alignment" runat="server" Text="Alignment: " Font-Size="Large"></asp:Label>  <br />
                    <asp:Label ID="Label_Gold" runat="server" Text="Gold: " Font-Size="Large"></asp:Label>  <br />
                    <br /><br /><br /><br /><br /><br />
                    <br /><br /><br /><br /><br />
                    <asp:Button ID="Button_Save" runat="server" Text="Save" PostBackUrl="~/LoadGame.aspx" style="width:100%;" OnClick="Button_Save_Click" />
                    <asp:Button ID="Button_Load" runat="server" Text="Load" PostBackUrl="~/SaveGame.aspx" style="width:100%;" OnClick="Button_Load_Click" />
