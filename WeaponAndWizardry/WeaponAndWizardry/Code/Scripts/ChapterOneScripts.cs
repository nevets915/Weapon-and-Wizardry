...
namespace WeaponAndWizardry.Code
{
    ...
    public partial class WebGameEngine
    {
        ...
        {
            ClearForegroundImages();
            AddForegroundImage("Albus_angry.png", 100, 20, 12, 640, 480);
        ...
        {
            ClearForegroundImages();
            AddForegroundImage("Albus_neutral.png", 100, 20, 12, 640, 480);
        ...
        {
            ClearForegroundImages();
            AddForegroundImage("Albus_happy.png", 100, 20, 12, 640, 480);
        ...
        private void Ch1Line39()
        {
            switch (_choicePicked)
            {
                ...
                case 2:
                    ClearForegroundImages();
                    AddForegroundImage("Albus_surprised.png", 100, 20, 12, 640, 480);
        ...
        {
            ClearForegroundImages();
            AddForegroundImage("Spider_neutral.png", 100, 20, 12, 640, 480);
