...
namespace WeaponAndWizardry.Code
{
    ...
    public partial class WebGameEngine
    {
        ...
        public void LoadPrologueScripts()
        {
            ...
            _scriptLines.Add(Prologue101);
            _scriptLines.Add(Prologue102);
        }
        ...
        private void Prologue4()
        {
            switch (_choicePicked)
            {
                ...
                case 2:
                    ClearImageDisplay();
                    SetBackgroundImage("01.png");
                    AddForegroundImage("Ilias_closed2.png", 100, 20, 12, 640, 480);
                    SetChoiceButtons(nextChoice);
        ...
        private void Prologue17()
        {
            switch (_choicePicked)
            {
                case 1:
                    ...
                    PrintTextDialogue("You rush over and see a soldier tied up.  He's being attacked by goblins!\n" +
                "What do you do?");
                    _currentExecutingLine++;
                    break;
        ...
        {
            SetChoiceButtons(nextChoice);
            PrintTextDialogue("The goblins swings back and hits you with a glancing blow. (-15 HP)");
            HP = HP - 15;
            _currentExecutingLine++;
        }
        ...
        private void Prologue27()
        {
            ...
            {
                case 1:
                    AddForegroundImage("Soldier_happy.png", 100, 20, 12, 640, 480);
                    SetChoiceButtons(nextChoice);
                ...
                case 2:
                    ClearImageDisplay();
                    SetBackgroundImage("11.png");
                    AddForegroundImage("Soldier_scared2.png", 100, 20, 12, 640, 480);
        ...
        private void Prologue30()
        {
            switch (_choicePicked)
            {
                case 1:
                    ClearImageDisplay();
                    SetBackgroundImage("11.png");
                    AddForegroundImage("Soldier_frustrated.png", 100, 20, 12, 640, 480);
                    SetChoiceButtons(nextChoice);
        ...
        private void Prologue31()
        {
            ClearImageDisplay();
            SetBackgroundImage("11.png");
            AddForegroundImage("Soldier_neutral.png", 100, 20, 12, 640, 480);
        ...
        private void Prologue39()
        {
            ...
            switch (_choicePicked)
            {
                ...
                case 2:
                    ...
                    SetChoiceButtons(nextChoice);
                    PrintTextDialogue("\"I accept the contract.\"");
        ...
        private void Prologue44()
        {
            ClearImageDisplay();
            SetBackgroundImage("20.png");
            AddForegroundImage("Merchant_angry1.png", 100, 20, 12, 640, 480);
            SetChoiceButtons(nextChoice);
        ...
        private void Prologue46()
        {
            ClearImageDisplay();
            SetBackgroundImage("20.png");
            AddForegroundImage("Merchant_sly1.png", 100, 20, 12, 640, 480);
        ...
        private void Prologue47()
        {
            ...
            ClearImageDisplay();
            SetBackgroundImage("20.png");
            AddForegroundImage("Merchant_angry2.png", 100, 20, 12, 640, 480);
        ...
        {
            AddForegroundImage("Halfling_neutral.png", 100, 20, 12, 640, 480);
        ...
        private void Prologue51()
        {
            ...
            {
                case 1:
                    PrintTextDialogue("\"Sure!\"");
                    AddForegroundImage("Halfling_happy.png", 100, 20, 12, 640, 480);
                    SetChoiceButtons(nextChoice);
                ...
                case 2:
                    PrintTextDialogue("\"Beat it, kid\"");
                    AddForegroundImage("Halfling_sad.png", 100, 20, 12, 640, 480);
        ...
        private void Prologue52()
        {
            ClearImageDisplay();
            SetBackgroundImage("27.png");
            AddForegroundImage("Halfling_interested.png", 100, 20, 12, 640, 480);
            SetChoiceButtons(nextChoice);
        ...
        private void Prologue69()
        {
            ...
            SetChoiceButtons(nextChoice);
            PrintTextDialogue("Running as fast as you can out of the forest, you lose the beast easily.");
            _currentExecutingLine++;
        }
        ...
        {
            SetChoiceButtons(nextChoice);
            PrintTextDialogue("The beast easily claws your vital organs and makes a quick meal of you.");
            _currentExecutingLine = _currentExecutingLine - 6;
        }
        ...
        private void Prologue98()
        {
            switch (_choicePicked)
            {
                case 1:
                    ...
                    if (_haggledReward)
                    {
                        PrintTextDialogue("\"Thank you\"\n" +
                        "You take the bag of gold and add it to your inventory. (+1000 gold)");
                        Gold = Gold + 1000;
                    }
                    else
                    {
                        PrintTextDialogue("\"Thank you\"\n" +
                        "You take the bag of gold and add it to your inventory. (+500 gold)");
                        Gold = Gold + 500;
                    }
                    _currentExecutingLine = _currentExecutingLine + 2;
                    break;
